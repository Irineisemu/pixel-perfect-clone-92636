...
export function DashboardProcesses() {
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      {/* 1. ALVOS & DESCOBERTAS */}
      {targets.length > 0 && (
        <section className="bg-white border border-zinc-200/60 rounded-[32px] p-5 md:p-8 space-y-6 shadow-[0_20px_40px_rgba(0,0,0,0.04),0_1px_3px_rgba(0,0,0,0.02)] relative overflow-hidden before:absolute before:inset-0 before:rounded-[32px] before:shadow-[inset_0_1px_1px_rgba(255,255,255,0.8)]">
      ...
      {(manualProcesses.length > 0 || pendingProcesses.length > 0) && (
        <section className="bg-white border border-zinc-100/80 rounded-[32px] p-5 md:p-8 space-y-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-zinc-50">
