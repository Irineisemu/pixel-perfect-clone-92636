              ...
              <div className="text-[13.5px] text-zinc-600 mt-0.5 flex items-center gap-1 flex-wrap">
                ...
                {stats.totalAlvos > 0 && (
                  <>
                    ...
                    <SourcesPopover stats={stats} dashboardData={dashboardData} onNav={onNav}>
          ...
          <div className="mt-6 grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6">
            ...
            <aside className="lg:sticky lg:top-[72px] lg:self-start space-y-4">
              ...
              <div className="text-[11.5px] text-zinc-500 px-1">
                Monitorando: <button onClick={() => onNav("alvos")} className="text-zinc-700 hover:text-zinc-900 hover:underline font-medium">{stats.totalMonitorado} processo{stats.totalMonitorado !== 1 ? "s" : ""}</button> · 
                <SourcesPopover stats={stats} dashboardData={dashboardData} onNav={onNav}>
                  <button className="text-zinc-700 hover:text-zinc-900 hover:underline font-medium">
                    {stats.totalAlvos} fonte{stats.totalAlvos !== 1 ? "s" : ""} de busca
                  </button>
                </SourcesPopover>
              </div>
            </aside>
